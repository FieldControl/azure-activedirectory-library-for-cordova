...
- run the following commands:
    ...
    ```
    cordova plugin rm cordova-plugin-ms-adal-fork --save
    cordova plugin add cordova-plugin-ms-adal-fork@0.8.x --save
    ```
